...
<%
     ...
     //try {
        ...
        String jrxmlFile = session.getServletContext().getRealPath(request.getContextPath())+"/MonthlyPayroll.jrxml";
        //String jrxmlFile = "MonthlyPayroll.jrxml";
    ...
    /*
        ...
        if(TruckingConnection!=null){
            TruckingConnection.close();
        }
    }
    */
%>

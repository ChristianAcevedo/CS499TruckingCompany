...
<%
        ...
        String jrxmlFile = session.getServletContext().getRealPath(request.getContextPath())+"/SingleVehicleMaintenanceReport.jrxml";
        InputStream input = new FileInputStream(new File(jrxmlFile));
        
        Map parameter = new HashMap();
        parameter.put("VehicleID", vehicleid);
 
        JasperReport jasperReport = JasperCompileManager.compileReport(input);
        JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, parameter, TruckingConnection);

                     ...
                     <%try{
                        while(EquipmentDataTable.next()){%>
                                <tr>
                                    ...
                                    <td><a href="MaintenanceData.jsp?maintenance_id_param=<%=EquipmentDataTable.getString(UserAccountInfo.EquipmentDataColumns.get("maintenance_record_id"))%>">Maintenance Record</a></td>
                                </tr> 
                        <%}%>
                    <%}catch(SQLException ex){
                        ex.printStackTrace();
